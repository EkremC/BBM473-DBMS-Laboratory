...
CREATE TABLE Contact(
  ...
  CONSTRAINT fk_contact FOREIGN KEY (userid) REFERENCES SYSTEMUSER(userid)
  );
...
CREATE TABLE PaymentDetail(
  ...
  CONSTRAINT fk_payment FOREIGN KEY (userid) REFERENCES SYSTEMUSER(userid) ON DELETE CASCADE
  );
...
CREATE TABLE LibraryTbl(
  ...
  CONSTRAINT fk_user_library FOREIGN KEY (userid) REFERENCES COMMERCIALUSER(userid) ON DELETE CASCADE,
...
CREATE TABLE Shelf(
  ...
  CONSTRAINT fk_shelf FOREIGN KEY (userid) REFERENCES COMMERCIALUSER(userid) ON DELETE CASCADE
  );
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'AUTHOR', author_seq.CURRVAL, 'I', sysdate);
    COMMIT;
  END;
/
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'BOOK', book_seq.CURRVAL, 'I', sysdate);
    COMMIT;
  END;
/
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'CATEGORY', category_seq.CURRVAL, 'I', sysdate);
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'EBOOK', file_seq.CURRVAL, 'I', sysdate);
    COMMIT;
  END;
/
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'AUDIOBOOK', file_seq.CURRVAL, 'I', sysdate);
    COMMIT;
  END;
/
...
IS
BEGIN
  INSERT INTO LIBRARYTBL
  SELECT p_userid, p_fileid, 0
  FROM dual
  WHERE NOT EXISTS (
      SELECT NULL FROM LIBRARYTBL 
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_insert_user, 'PUBLISHER', publisher_seq.CURRVAL, 'I', sysdate);
    COMMIT;
  END;
/
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_last_update_user, 'AUTHOR', p_authorid, 'U', sysdate);
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_last_update_user, 'BOOK', p_bookid, 'U', sysdate);
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_last_update_user, 'CATEGORY', p_categoryid, 'U', sysdate);
...
IS
  BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_last_update_user, 'EBOOK', p_fileid, 'U', sysdate);
...
BEGIN
  ...
  INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_last_update_user, 'AUDIOBOOK', p_fileid, 'U', sysdate);
...
BEGIN
    ...
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_userid, 'EBOOK', p_fileid, 'D', sysdate);
END;
/
...
BEGIN
    FILE_DELETE(p_fileid);
    INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_userid, 'AUDIOBOOK', p_fileid, 'D', sysdate);
END;
/
...
BEGIN
  ...
  INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
  VALUES (p_userid, 'AUTHOR', p_authorid, 'D', sysdate);
END;
/
...
BEGIN
  ...
  INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
  VALUES (p_userid, 'BOOK', p_bookid, 'D', sysdate);
END;
/
...
BEGIN
  ...
  INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
  VALUES (p_userid, 'CATEGORY', p_categoryid, 'D', sysdate);
END;
/
...
BEGIN
  ...
  INSERT INTO LOGTBL (userid, tablename, objectid, operation_type, log_date)
    VALUES (p_userid, 'PUBLISHER', p_publisherid, 'D', sysdate);
END;
/
