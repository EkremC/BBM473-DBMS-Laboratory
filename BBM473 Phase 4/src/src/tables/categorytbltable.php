<div class="ui icon buttons">
    <button class="ui blue button" onclick="crud(0, 'categorytbl')">
        <i class="plus icon"></i>
        Add
    </button>
    <button class="ui orange button" onclick="crud(1, 'categorytbl')">
        <i class="edit icon"></i>
        Edit
    </button>
    <button class="ui red button" onclick="crud(2, 'categorytbl')">
