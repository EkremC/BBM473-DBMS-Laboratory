...
<body>
	<div class="ui container">
		<div class="ui text container" style="padding: 50px; size: 200px;">
			<h1 class="ui header" style="text-align: center">AudioBook Add</h1>
			<form id="audiobook-info-form" action="register.php" method="post" class="ui form">
				<div class="field">
				...
				<div class="field">
					...
					<input type="text" name="audiobook-duration" placeholder="Duration">
				</div>
				<div class="field">
					<label>AudioBook File</label>
					<input type="text" name="audiobook-file" placeholder="AudioBook File">
				</div>
				</div>
			</form>
			<div class="actions">
